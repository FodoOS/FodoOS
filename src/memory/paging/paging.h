...
enum
{
  // 512 GB approx (all 512 entries of the PLM4 map to 512 GB of maximuim memory
  // ig all entries are filled)
...
/**
 * @brief Structure for any paging entry that is a part of paging
 * For example this can be a paging table entry, a page directory entry
 * or a page map level four entry.
 */
