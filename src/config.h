...
#define FODOOS_PROGRAM_VIRTUAL_STACK_ADRESS_START 0x3FF000
#define FODOOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END FODOOS_PROGRAM_VIRTUAL_STACK_ADRESS_START - FODOOS_USER_PROGRAM_STACK_SIZE
