FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/string/string.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.asm.o ./build/memory/paging/paging.o ./build/disk/disk.o ./build/fs/pparser.o
INCLUDES = -I./src
